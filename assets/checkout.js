...
const CHECKOUT_COPY = {
  pt: {
    ...
    kit_completo: { price: 'R$ 28,90', note: 'pagamento único · PDF por e-mail', productName: 'Kit Completo VisCare Kids' },
    ...
    combo_jogos_baralho: { price: 'R$ 59,98', note: 'pagamento único · PDF por e-mail', productName: 'Combo: Livro + Baralho do Foco + Kit Completo' },
